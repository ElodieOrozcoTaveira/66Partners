      ...
      <tr>
        <td align="center">
          <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:480px; background-color:#FFF7EB; border-radius:16px; overflow:hidden; box-shadow:0 4px 16px rgba(31,41,55,0.08);">
            <tr>
              <td style="background:linear-gradient(90deg, #E6392E 0%, #EF4B2D 35%, #F66A1A 70%, #F4A61D 100%); padding:28px 24px; text-align:center;">
            ...
            <tr>
              <td style="padding:0 28px 32px; text-align:center;">
                <a href="https://66partners.fr/sports"
                   style="display:inline-block; padding:12px 32px; border-radius:30px; background:linear-gradient(90deg, #E6392E 0%, #EF4B2D 35%, #F66A1A 70%, #F4A61D 100%); color:#FFFFFF; font-family: Arial, Helvetica, sans-serif; font-size:15px; font-weight:bold; text-decoration:none;">
